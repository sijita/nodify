...
export const es: Dict = {
  ...
  addSkill: {
    title: "NUEVA SKILL",
    nameLabel: "NOMBRE",
    namePh: "p.ej. code-review",
    modeGuided: "Guiado",
    modePaste: "Pegar existente",
    descriptionLabel: "DESCRIPCIÓN",
    descriptionPh: "Qué hace y CUÁNDO usarla",
    ...
    installIn: "CREAR EN",
    create: "Crear",
    tipsTitle: "Cómo escribir una buena skill",
    tip1: "Nombre en kebab-case, enfocado en una sola tarea.",
    tip2: "La descripción es lo que el agente lee para decidir cuándo usarla — di qué hace Y cuándo.",
    tip3: "En el cuerpo: instrucciones paso a paso, ejemplos y qué evitar.",
  },
  align: {
    title: "ALINEAR",
    intro:
